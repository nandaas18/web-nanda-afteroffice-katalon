...
WebUI.setText(findTestObject('Page_Forms/input_Email'), 'nanda.gmail.com')
...
WebUI.verifyOptionNotPresentByLabel(findTestObject('Page_Forms/lbl_formSubmit'), '', false, 0)
